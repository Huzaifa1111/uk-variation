...
import { FaBezierCurve, FaHandsHelping, FaHireAHelper, FaProductHunt } from "react-icons/fa";
import { FiHelpCircle, FiPackage, FiUserCheck } from "react-icons/fi";
              ...
              <div className="promo-card-wrap promo-border-hover border border-2 bg-white rounded-custom p-5 mb-4 mb-lg-0 mb-md-4">
                <div className="promo-card-info">
                  <div className="d-flex">
                    ...
                    <h3 className="display-5 fw-medium mb-4">5,000+</h3>
                  </div>
