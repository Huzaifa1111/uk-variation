              ...
              <div className="about-content-left">
                <div className="about-info mb-5">
                  <h1 className="fw-bold display-5">
                    Naxi, an online platform for wholesellers based in UAE.
                  </h1>
                  <p className="lead">
                  ...
                  <Link href={appRoutes.contactUs}>
                    <a className="btn btn-soft-primary mt-4">Contact Us</a>
                  </Link>
                </div>
                {/* <img src="/about-img-1.jpg" alt="about" className="img-fluid about-img-first mt-5 rounded-custom shadow" /> */}
              </div>
              <div className="about-content">
                <img src="/pages-images/about.jpg" alt="about" className="img-fluid   rounded-custom shadow" />
