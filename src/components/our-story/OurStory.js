            ...
            <div className="story-grid-wrapper position-relative">
              ...
              <div className="story-grid rounded-custom bg-dark overflow-hidden position-relative">
                <div className="story-item bg-light border">
                  <h3 className="display-5 fw-bold mb-1 text-success">5,000+</h3>
                  <h6 className="mb-0">Products </h6>
                </div>
                <div className="story-item bg-white border">
                  <h3 className="display-5 fw-bold mb-1 text-primary">50+</h3>
                  <h6 className="mb-0">Categories</h6>
                </div>
                <div className="story-item bg-white border">
                  <h3 className="display-5 fw-bold mb-1 text-dark">2000+</h3>
                  <h6 className="mb-0">Active Sellers</h6>
                </div>
                {
                  <div className="story-item bg-light border">
                    ...
                    <h6 className="mb-0">Orders Delivered</h6>
                  </div>
               /* <div className="story-item bg-light border">
