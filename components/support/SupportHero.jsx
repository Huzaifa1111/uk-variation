export default function SupportHero() {
  return (
    <section className="bg-gradient-to-r from-[#1C45A7] to-[#0B1B41] text-white py-16 md:py-24">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="max-w-2xl mx-auto mt-8">
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 rounded-lg text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-lg"
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all">
            ...
            <h3 className="text-xl font-semibold mb-2">FAQ Center</h3>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all">
            ...
            <p className="text-blue-100">Detailed guides and tutorials</p>
          </div>
        </div>
      </div>
    </section>
