          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Collaboratively promote client-focused convergence via awk customer directed 
                alignments via standardized infrastructure...
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@naxi.com" className="text-blue-600 hover:underline font-medium">
                      hello@naxi.com
                    </a>
                  </div>
                </div>
